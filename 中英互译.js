/**erots
id: 5cea4e9b30863b006813f555
build: 5
source: b1c1014c2c954c899bfaff91489275c2
*/
"use strict"
...
function setupView() {
  ...
  if(isInToday()) {
    textViewContent.events = {
      tapped: function(sender) {
        if(isInToday()) {
          $input.text({
            type: $kbType.default,
            placeholder: "输入带翻译的内容",
